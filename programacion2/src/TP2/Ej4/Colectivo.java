...
public class Colectivo extends Transporte {
    ...
    public Colectivo(String identificador, float velociad_promedio, String tipo, double horario_salida, int cant_pasajeros) {
    ...
    public Colectivo setIdentificador(String identificador) {
        this.identificador = identificador;
        return this;
    }
    ...
    public Colectivo setHorario_salida(double horario_salida) {
        this.horario_salida = horario_salida;
        return this;
    }
    ...
    public Colectivo setCant_pasajeros(int cant_pasajeros) {
        this.cant_pasajeros = cant_pasajeros;
        return this;
    }
}